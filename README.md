...
* Android
  ...
  * If you need to connect the application to local server, change the the ip address provided in the loadweb function call and ip address provided in the shouldOverrideUrlLoading function to your server's local ip address.
